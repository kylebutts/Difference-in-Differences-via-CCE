...
\begin{table}[tbh]
  ...
  \begin{center}\begin{spacing}{1.1}
    \begin{tabular}{
      @{} r @{\extracolsep{6pt}} r 
      @{\extracolsep{12pt}} r @{\extracolsep{6pt}} rrrrr 
      @{}
    }
      \toprule  
      & & & \multicolumn{3}{c}{\small GSC}  & \multicolumn{2}{c}{\small TWFE} \\ 
      \cline{4-6} \cline{7-8}
      \multicolumn{1}{c}{\small $N$} & \multicolumn{1}{c}{\small $T$} & 
      \multicolumn{1}{c}{\small TECCE} & \multicolumn{1}{c}{\small No Controls} & \multicolumn{1}{c}{\small + $\*x_{i,t}$} & \multicolumn{1}{c}{\small + TWFE} & \multicolumn{1}{c}{\small No Controls} & \multicolumn{1}{c}{\small + $\*x_{i,t}$} \\ 
      \midrule

      \\[-8pt]
      \multicolumn{7}{c}{\small\textbf{Factor specification:} $f_t = 1$}
      \\[4pt]

      \input{tables/simulation/tab-fact_constant-dgp_1-eps_auto_0.tex}

      \\[-6pt]
      \multicolumn{7}{c}{\small\textbf{Factor specification:} $f_t = 1 + t/8$}
      \\[4pt]

      \input{tables/simulation/tab-fact_linear_trend-dgp_1-eps_auto_0.tex}

%       \\[-6pt]
%       \multicolumn{7}{c}{\small\textbf{Factor specification:} $f_t = 1.5 + v_t$}
%       \\[4pt]
% 
...
\begin{table}[tbh]
  \caption{Monte Carlo results with $\kappa = -0.5$ and $\tau = 0$ with autocorrelated $\varepsilon$.}
  \label{tab:mc_2_autocorrelated}
  \begin{center}\begin{spacing}{1.1}
    \begin{tabular}{
      @{} r @{\extracolsep{6pt}} r 
      @{\extracolsep{12pt}} r @{\extracolsep{6pt}} rrrrr 
      ...
      \input{tables/simulation/tab-fact_constant-dgp_2-eps_auto_1.tex}

      \\[-6pt]
      \multicolumn{7}{c}{\small\textbf{Factor specification:} $f_t = 1 + t/8$}
      \\[4pt]

      \input{tables/simulation/tab-fact_linear_trend-dgp_2-eps_auto_1.tex}

      % \\[-6pt]
      % \multicolumn{7}{c}{\small\textbf{Factor specification:} $f_t = 1.5 + v_t$}
      % \\[4pt]

      % \input{tables/simulation/tab-fact_autocorrelated-dgp_2-eps_auto_1.tex}
